(function (global, factory) {
	...
	(function ($, window, document, undefined) {
		...
		Owl.prototype.replace = function (content) {
			...
			content.filter(function () {
				...
				var hasClassState = $(item).hasClass('owl-stage');
				if (!hasClassState) {
		...
		Owl.prototype.on = function (element, event, listener, capture) {
			if (element.addEventListener) {
				element.addEventListener(event, listener, { capture: capture, passive: true });
		...
		Owl.prototype.off = function (element, event, listener, capture) {
			if (element.removeEventListener) {
				element.removeEventListener(event, listener, { capture: capture, passive: true });
	...
	(function ($, window, document, undefined) {
		...
		Navigation.Defaults = {
			...
			navSpeed: false,
			navElement: 'button type="button" aria-label="owl-dots" role="presentation"',
			navContainer: false,
