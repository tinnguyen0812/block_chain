...
import { faCircle, faPlus } from '@fortawesome/fontawesome-free-solid';
					...
					<div className="container-fluid">
						<div className="row align-items-center">
							...
							<div className="col-auto text-right float-right ml-auto">
								<Link to="#0" className="btn btn-primary btn-sm"  onClick={() => this.handleClick()}>Create Event</Link>
							</div>
						</div>
					</div>
				</div>
								...
								<div className="card">
									...
									<div className="card-body">
										<div id="calendar-events" className="mb-3">
											<div className="calendar-events"><FontAwesomeIcon icon={faCircle} className='text-info' /> My Event One</div>
											<div className="calendar-events"><FontAwesomeIcon icon={faCircle} className='text-success' /> My Event Two</div>
											<div className="calendar-events"><FontAwesomeIcon icon={faCircle} className='text-danger' /> My Event Three</div>
											<div className="calendar-events"><FontAwesomeIcon icon={faCircle} className='text-warning' /> My Event Four</div>
										</div>
										...
										<Link to="#0" className="btn btn-primary btn-block">
